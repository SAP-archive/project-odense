CLASS cx_adt_rest_abapgit DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS raise_with_error
      IMPORTING
        ...
        !iv_properties  TYPE REF TO if_adt_exception_properties OPTIONAL
      RAISING
        cx_adt_rest_abapgit .
    METHODS constructor
      IMPORTING
...
CLASS cx_adt_rest_abapgit IMPLEMENTATION.
