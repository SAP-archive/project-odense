...
CLASS ltcl_simple_transformation IMPLEMENTATION.
  ...
  METHOD pos_st_repo_post_seq_ok.
    ...
    <lt_result>-name = cl_abapgit_res_repos=>co_root_name_post.
  ...
  METHOD repo_v2_serialize_ok.
    DATA: lo_repository_data TYPE cl_abapgit_res_repos=>tt_request_data,
          lv_xml_data        TYPE string.

    lo_repository_data = VALUE #( ( url = 'https://github.com/Wunderfitz/yy.git'
    ...
    CALL TRANSFORMATION abapgit_st_repo_post_v2
      SOURCE repositories = lo_repository_data
